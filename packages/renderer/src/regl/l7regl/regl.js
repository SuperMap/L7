...
var isWebgl2 = function(gl) {
  return gl.__proto__.constructor.name === 'WebGL2RenderingContext';
}
...
function createExtensionCache (gl, config) {
  ...
  function getExtension(name) {
    ...
    } else if (isWebgl2(gl) && COMP_WEBGL2.includes(name)) {
      return {}
    } else {
      return null
    }
...
// var GL_LUMINANCE = 0x1903
// var GL_LUMINANCE_ALPHA = 	0x8227
...
function wrapAttributeState (
  ...
  function extInstanced () {
    const exi = extensions.angle_instanced_arrays;
    if (isWebgl2(gl)){
      exi.vertexAttribDivisorANGLE = gl.vertexAttribDivisor;
    }
    return exi;
...
function wrapREGL (args) {
  ...
  var regl = extend(compileProcedure, {
    ...
    _refreshTexture: textureState.refresh,
    poll: function () {
      poll()
      if (timer) {
        timer.update()
