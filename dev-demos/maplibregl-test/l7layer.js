...
export function addBaseLayer() {
  ...
  var polygonlayer = new maplibregl.supermap.L7Layer({ type: 'PolygonLayer' });
...
function createCircleArc(map) {
  fetch('../js/UEXQMifxtkQlYfChpPwT.txt')
    ...
    .then((data) => {
      ...
      // var layer1 = new maplibregl.supermap.L7Layer({ type: 'LineLayer' });
...
function createOD(map, scene) {
  ...
  Promise.all([
    fetch(
      '../js/2960e1fc-b543-480f-a65e-d14c229dd777.json',
    ).then((d) => d.json()),
    fetch(
    ...
    var flyLine = new maplibregl.supermap.L7Layer({
      type: 'LineLayer',
      options: { blend: 'normal' },
    });
    flyLine
    ...
    var flyLine2 = new maplibregl.supermap.L7Layer({
      type: 'LineLayer',
      options: { blend: 'normal' },
    });
    flyLine2
  ...
  fetch(
    ...
    .then(({ lakeData }) => {
      ...
      l7Layer
        ...
        .animate(true);
      var layer1 = new maplibregl.supermap.L7Layer({
        type: 'PolygonLayer',
      });
      var l7Layer1 = layer1.getL7Layer();
...
export function createMvtLayer(map) {
  ...
  var fill = new maplibregl.supermap.L7Layer({
    type: 'PolygonLayer',
